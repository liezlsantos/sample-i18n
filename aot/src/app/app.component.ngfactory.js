...
export var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_0 = import3.createRenderElement(this.renderer, parentRenderNode, 'h1', new import3.InlineArray2(2, 'i18n', ''), null);
        this._text_1 = this.renderer.createText(this._el_0, 'Hello world!', null);
        this._text_2 = this.renderer.createText(parentRenderNode, '\n', null);
        this._el_3 = import3.createRenderElement(this.renderer, parentRenderNode, 'p', new import3.InlineArray2(2, 'i18n', 'meaning|desc@id'), null);
        this._text_4 = this.renderer.createText(this._el_3, 'Good morning!', null);
