...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_0 = import3.createRenderElement(this.renderer,parentRenderNode,'h1',new import3.InlineArray2(2,'i18n',''),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'Hello world!',(null as any));
    this._text_2 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_3 = import3.createRenderElement(this.renderer,parentRenderNode,'p',new import3.InlineArray2(2,'i18n','meaning|desc@id'),(null as any));
    this._text_4 = this.renderer.createText(this._el_3,'Good morning!',(null as any));
