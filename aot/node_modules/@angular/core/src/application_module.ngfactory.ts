...
class ApplicationModuleInjector extends import0.NgModuleInjector<import1.ApplicationModule> {
  ...
  get _LOCALE_ID_10():any {
    if ((this.__LOCALE_ID_10 == null)) { (this.__LOCALE_ID_10 = 'es'); }
    return this.__LOCALE_ID_10;
  }
  get _TRANSLATIONS_FORMAT_11():any {
    if ((this.__TRANSLATIONS_FORMAT_11 == null)) { (this.__TRANSLATIONS_FORMAT_11 = 'xlf'); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import17.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_11; }
